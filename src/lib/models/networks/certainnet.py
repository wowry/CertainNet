...
class CertainNet(nn.Module):
    def __init__(self, base_name, heads, pretrained, down_ratio, final_kernel,
                 last_level, head_conv, opt, out_channel=0, init_conv=False):
        ...
        for c in range(opt.num_classes):
            ...
            if init_conv:
              nn.init.kaiming_normal_(self.__getattr__(f'conv1x1_{c}').weight, nonlinearity="relu") # improve learning stability
